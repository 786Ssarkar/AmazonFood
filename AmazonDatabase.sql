USE [db_AmazonFood]
GO
/****** Object:  Table [dbo].[Mst_tblItemMaster]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Mst_tblItemType]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mst_tblItemUnit]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mst_tblUserRegistraion]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mst_tblUserType]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblDistrict]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblDivision]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Trn_tblAddStock]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Trn_tblAddStockChild]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Trn_tblCart]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Trn_tblOrder]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Trn_tblStock]    Script Date: 14-May-24 2:39:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
SET IDENTITY_INSERT [dbo].[Mst_tblItemMaster] ON 
GO
INSERT [dbo].[Mst_tblItemMaster] ([ItemId], [ItemName], [ItemTypeId], [UnitId], [SaleAmount], [PurchaseAmount], [ItemImagePath], [ItemCode], [IsActive], [CreatedBy], [CreatedOn], [CreatedByIp]) VALUES (1, N'Veg Biryani', 2, NULL, NULL, NULL, NULL, N'AA-000', 1, 0, CAST(N'2024-05-13T16:00:42.887' AS DateTime), N'::1')
GO
INSERT [dbo].[Mst_tblItemMaster] ([ItemId], [ItemName], [ItemTypeId], [UnitId], [SaleAmount], [PurchaseAmount], [ItemImagePath], [ItemCode], [IsActive], [CreatedBy], [CreatedOn], [CreatedByIp]) VALUES (2, N'Butter Pizza', 1, NULL, NULL, NULL, NULL, N'AA-001', 1, 1, CAST(N'2024-05-14T10:51:16.770' AS DateTime), N'::1')
GO
SET IDENTITY_INSERT [dbo].[Mst_tblItemMaster] OFF
GO
...
GO
INSERT [dbo].[Mst_tblItemType] ([ItemTypeId], [ItemTypeName], [IsActive], [CreatedBy], [CreatedOn], [CreatedByIp], [UnitId]) VALUES (2, N'biryani', 1, 1, CAST(N'2024-05-10T16:36:32.380' AS DateTime), N'::1', 2)
GO
...
GO
INSERT [dbo].[Mst_tblUserRegistraion] ([UserId], [UserTypeId], [UserName], [DivisionId], [DistrictId], [Email], [Password], [Mobile], [Gender], [Address], [ShopName], [PanNo], [ShopAddress], [UserImage], [IsActive], [CreatedBy], [CreatedOn], [CreatedByIp]) VALUES (5, 3, N'Manoj', 2, 7, N'Manoj@gmail.com', N'oZO7To6b/7BINnYItjN9pVZLeo5P/+A6wqaMZyF4oqITxZqCkdefemOk5RkpTu/Pp+3/Q7V2j8igg+QVR8CxRw==', N'7884561230', 1, N'at burhanpur, post salidhana', N'Veg and Nonveg Stall', N'werty1234y', N'at heerapur, post salidhana', N'User_Avatar.jpg', 1, 1, CAST(N'2024-05-08T19:55:07.403' AS DateTime), N'::1')
GO
INSERT [dbo].[Mst_tblUserRegistraion] ([UserId], [UserTypeId], [UserName], [DivisionId], [DistrictId], [Email], [Password], [Mobile], [Gender], [Address], [ShopName], [PanNo], [ShopAddress], [UserImage], [IsActive], [CreatedBy], [CreatedOn], [CreatedByIp]) VALUES (11, 2, N'Dheeraj', 1, 3, N'drzmalviya@gmail.com', N'JSSxuVObCcoekToyoID9bja6y0h2Ffgj4MpM1/sCQejnVXYnC5XWfwc0I8WtFUxDSO52VTfWDo51pG32Roe8tQ==', N'9876543210', 1, N'at rajgarh post rajgarh', NULL, NULL, NULL, N'User_Avatar.jpg', 1, NULL, CAST(N'2024-05-13T12:14:53.817' AS DateTime), N'::1')
GO
...
GO
/****** Object:  StoredProcedure [dbo].[UspMst_RegItem]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE proc  [dbo].[UspMst_RegItem]
...
begin
	...
	begin try
		begin transaction
			...
			if not exists(select 1 from [Mst_tblItemMaster] where ItemName=@ItemName)
			begin
				declare @ItemCode					varchar(6)			=		null;
	
				select top 1 @ItemCode=ItemCode from [Mst_tblItemMaster] ORDER BY ItemCode DESC;
				IF @ItemCode IS NULL
				BEGIN
					SET @ItemCode = 'AA-000';
				END
				ELSE
					BEGIN
						DECLARE @AlphabeticalPart CHAR(2) = LEFT(@ItemCode, 2)
						DECLARE @NumericPart INT = CAST(SUBSTRING(@ItemCode, 4, 3) AS INT)
		
						IF @NumericPart = 999
							BEGIN
								IF RIGHT(@AlphabeticalPart, 1) = 'Z'
									BEGIN
										SET @AlphabeticalPart = CHAR(ASCII(LEFT(@AlphabeticalPart, 1)) + 1) + 'A'
									END
								ELSE
									BEGIN
										SET @AlphabeticalPart = LEFT(@AlphabeticalPart, 1) + CHAR(ASCII(RIGHT(@AlphabeticalPart, 1)) + 1)
									END
								SET @NumericPart = 0
							END
						ELSE
						...
						SET @ItemCode = @AlphabeticalPart + '-' + RIGHT('000' + CAST(@NumericPart AS VARCHAR(3)), 3)
					END
				INSERT INTO [dbo].[Mst_tblItemMaster]
							(ItemName
							,[ItemTypeId]
							,[ItemCode]
							,[IsActive]
					...
					select @msg ='Item declared Successfully', @status=1
				end
			else
				begin
					select @msg ='Item Already exists', @status=0
				end
		commit
	end try
	begin catch
...
GO
/****** Object:  StoredProcedure [dbo].[UspMst_RegItemType]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[UspMst_UserReg]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[UspTrn_BindDDL]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
declare @msg varchar (50) ='', @Status bit=0
	 if (@table='Division')
		 begin
			...
			set @Status= 1
			set  @msg ='Division  Drop Down filled Successfully'
		 end
		...
		select tbl.DistrictId  Id,tbl.DistrictName Name from  tblDistrict tbl where DivisionId=@Id or  (@Id = '' or @Id is null)
			set @Status= 1
			set  @msg ='District  Drop Down filled Successfully'
		 end
	else if (@table='Unit')
		 begin
		select tbl.UnitId  Id,tbl.UnitName Name from  Mst_tblItemUnit tbl 
			set @Status= 1
			set  @msg ='Unit  Drop Down filled Successfully'
		 end
		 else if (@table='ItemType')
		 begin
		select tbl.ItemTypeId  Id,tbl.ItemTypeName Name from  Mst_tblItemType tbl 
			set @Status= 1
			set  @msg ='Item Type  Drop Down filled Successfully'
		 end
		  else if (@table='Item')
		 begin
		select tbl.ItemId  Id,tbl.ItemName Name from  Mst_tblItemMaster tbl 
			set @Status= 1
			set  @msg ='Item Drop Down filled Successfully'
		 end
	 else
	 begin
			set @Status= 0
...
GO
/****** Object:  StoredProcedure [dbo].[Usptrn_GetItem]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE proc  [dbo].[Usptrn_GetItem]
...
begin transaction
	if exists(select * from [Mst_tblItemMaster])
	begin
	select [Item].ItemId 
	, [Item].ItemName
	, [type].[ItemTypeName] 
	,[Item].ItemCode 
	,case 
		When [Item].[IsActive]=0 then 'No'  
		When [type].[IsActive]=1 then 'Yes' 
		else 'Undefined' 
		end [IsActive]
	,[user].[UserName] 
	,FORMAT([type].[CreatedOn],'dd/MM/yyyy hh:mm:s tt') [CreatedOn]
	,case 
			When [type].[CreatedByIp]='::1' then '127.0.0.1' 
			else [type].[CreatedByIp] 
			end [CreatedByIp]

	from [Mst_tblItemMaster] [Item]
	join [dbo].[Mst_tblItemType] [type] on [Item].[ItemTypeId]=[type].[ItemTypeId]
	join Mst_tblUserRegistraion [user] on [user].[UserId]=[type].[CreatedBy]



		select @msg ='Item Selected Successfully', @status=1
	end
	else
	begin
		select @msg ='Item  Not Found', @status=0
	end
commit
end try
begin catch
...
GO
/****** Object:  StoredProcedure [dbo].[Usptrn_GetItemType]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[UspTrn_Login]    Script Date: 14-May-24 2:39:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
