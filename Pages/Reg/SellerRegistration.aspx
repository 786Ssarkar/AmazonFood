<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Amazon.master" AutoEventWireup="true" CodeFile="SellerRegistration.aspx.cs" Inherits="Pages_Seller_SellerRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div runat="server" id="divAlert" class="" clientidmode="Static">
    </div>
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class=" col-md-4 mb-3">
                    ...
                    <div class="form-control align-items-center justify-content-between d-flex p-1">
                ...
                <div class=" col-md-4 mb-3">
                    <label for="txtCnfPass" class="form-label">Confirm Password<span class="span">*</span></label>
                    <div class="form-control align-items-center justify-content-between d-flex p-1">
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    ...
                    <label for="txtPan">Pan Number</label><span class="span">*</span>
                    <asp:TextBox runat="server" MaxLength="10" AutoComplete="off" ID="txtPan" placeholder="Enter Pan Number" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ErrorMessage="Pan Number is Required" ControlToValidate="txtPan" ForeColor="Red" Display="Dynamic" ValidationGroup="a" runat="server" />
                    <asp:RegularExpressionValidator ErrorMessage="Enter valid Pan Number" ValidationExpression="^[A-Za-z]{5}[0-9]{4}[A-Za-z]{1}" ForeColor="Red" Display="Dynamic" ValidationGroup="a" ControlToValidate="txtPan" runat="server" />
                </div>
                <div class="col-md-4">
                    <label for="txtShopName">Shop Name</label><span class="span">*</span>
                    <asp:TextBox runat="server" AutoComplete="off" placeholder="Enter Shop Name" ID="txtShopName" CssClass="form-control"></asp:TextBox>
                    <asp:RegularExpressionValidator ErrorMessage="Only English letters" ForeColor="Red" Display="Dynamic" ValidationExpression="^[a-zA-Z ]+$" ValidationGroup="a" ControlToValidate="txtShopName" runat="server" />
                    <asp:RequiredFieldValidator ErrorMessage="Shop Name is Required" ForeColor="Red" Display="Dynamic" ValidationGroup="a" ControlToValidate="txtShopName" runat="server" />
                </div>
                <div class="col-md-4">
                    <label for="txtShopAddress">Shop Address</label><span class="span">*</span>
                    <asp:TextBox runat="server" AutoComplete="off" ID="txtShopAddress" TextMode="MultiLine" placeholder="Enter Shop Address" Rows="1" CssClass="form-control autosized"></asp:TextBox>
                    <asp:RequiredFieldValidator ErrorMessage="Shop Address is Required" ForeColor="Red" Display="Dynamic" ValidationGroup="a" ControlToValidate="txtShopAddress" runat="server" />
                </div>
            </div>
