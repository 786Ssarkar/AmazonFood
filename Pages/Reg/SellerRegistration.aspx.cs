...
public partial class Pages_Seller_SellerRegistration : System.Web.UI.Page
{
    ...
    protected void btnReg_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            using (SqlDataAdapter adpt = new SqlDataAdapter("UspMst_UserReg", Connstr))
            {
                ...
                new SqlParameter("@ShopAddress", txtShopAddress.Text.Trim()),
                    ...
                    if (ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            if (Convert.ToBoolean(ds.Tables[0].Rows[0]["status"]))
                            {
                                ...
                                string MailBody = "Hello <b>" + txtName.Text.Trim() + "</b>,<br/>&nbsp; You have successfully registered  in Amazon Food as a Seller. Now You Can sell your food items on this web site" + "<br/> <br/>   Username :" + txtMobile.Text.Trim() + " <br/> PassWord :" + txtPassword.Text;
                                try
                                {
                                ...
                                catch (Exception ex)
                                {
                                    ...
                                    sb.Append("<b>!Error </b> <br/>" + ex.Message.ToString());
